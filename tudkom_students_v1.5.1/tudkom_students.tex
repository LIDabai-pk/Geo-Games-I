...
\newcommand{\komTitle}{Geo and Games I\xspace} 
% Translation of the title in either DE or EN, depending on thesis language
\newcommand{\komTitleTranslation}{\xspace}
...
\newcommand{\komSubmissionDate}{11. Dec 2021\xspace}% use only this date format

\newcommand{\komGutachter}{Gutachter: Dr.Stefan Göbel\xspace}
